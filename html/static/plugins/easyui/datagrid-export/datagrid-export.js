(function($){
    ...
    function toExcel(target, param){
        ...
        if (typeof param == 'string'){
            ...
            sheettitle = param['title']||param['worksheet'];
        }
        var dg = $(target);
        ...
        var table = toHtml(target, rows, sheettitle);
        //table += table;
        var ctx = { worksheet: worksheet, table: table };
        var data = base64(format(template, ctx));
        //ctx = { worksheet: '12345', table: table };
        //var data2 = base64(format(template, ctx));
        //data += data2;
    ...
    $.extend($.fn.datagrid.methods, {
        ...
        toHtml2: function(jq, param){
            return toHtml(jq[0], param.rows, param.title);
        },
