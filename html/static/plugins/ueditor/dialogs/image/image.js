    ...
    SearchImage.prototype = {
        ...
        getImageData: function(){
            var _this = this,
                ...
                url = 'https://image.baidu.com/search/acjson?tn=resultjson_com&ipn=rj&ct=201326592&is=&fp=result&queryWord='+encodeURI(key)+'&cl=2&ie=utf-8&oe=utf-8&adpicid=&z=&ic=0&word='+encodeURI(key)+'&se=&tab=&width=&height=&istype=2&qc=&nc=1&fr=&pn=0&rn=1000&gsm=0&'+new Date+'=&'+type;
                ...
                'onsuccess':function(json){
                    var list = [];
                        ...
                        for(var i = 0; i < json.data.length-1; i++) {
                            if(json.data[i].fromPageTitleEnc) {
                                list.push({
